...
public class DetailZodiac extends AppCompatActivity {

    TextView tvTemp, tvHum, tvJam, tvTgl, tvKondisi,
            tvSortLive, tvSortClock, tvSortDay,
            tvBtnOrbital, tvBtnViasat, tvBtnServer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_zodiac);
    ...
    private void init() {
        ...
        tvBtnServer = findViewById(R.id.tvBtnServer);
    }
    ...
    private void onClick() {
        ...
        tvBtnOrbital.setOnClickListener(v -> {
            Intent orbital = new Intent(DetailZodiac.this, DetailOrbital.class);
        ...
        tvBtnViasat.setOnClickListener(v -> {
            Intent viasat = new Intent(DetailZodiac.this, DetailViasat.class);
        ...
        tvBtnServer.setOnClickListener(v -> {
            Intent server = new Intent(DetailZodiac.this, DetailServer.class);
